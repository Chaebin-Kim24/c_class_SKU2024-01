...
int main(void)
{
    ...
    // 정답: p3_i = 1, p3_j = 0, p3_x = 2.000000, p3_y = 1.100000
...
p5_print:
    ...
    do
    {
        ...
        p14_j = p14_i;
         ...
         for(int x = 1; x < p14_i; x++)
         {
         p14_j = ((-1) ^ (x - 1))(p14_j + 2(x-1))
         x++
         }while(x <= 5)
    ...
    do
    {
        printf("\n\ni = %d,     j = ", p15_i);
         ...
         p15_j == p15_i;
         p15_j -= 5;
         for(int x = 1; x < p15_i; x++)
         {
         p15_j = ((-1) ^ (x - 1))(p15_j + 3(x-1))
         x++
         }while(x <= 4)
    ...
    int y = 0;
    int how;
    printf("계산하고자 하는 정수 두 개를 입력해 주세요\n");
    scanf("%d %d", &x, &y);
    printf("계산하고자 하는 연산을 입력해 주세요.\n");
    scnaf("%s", &how);
    swtich(how)
    {
       case '+':
