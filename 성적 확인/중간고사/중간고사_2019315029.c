...
int main(void)
{
	...
	// 정답: float p2_krw_usd_rate = p2_krw / p2_usd;
	...
	// 정답: 1) Problem 3: p3_i = 1, p3_j = 0, p3_x = 1.100000, p3_y = 1.100000 
...
p5_print:
	...
	// 정답: 1 (출력 1번째 라인부터 *10개 나온거 다 제외했습니다.)
	...
	do
	{
		...
		p14_j = p14_i;
		/* 코드를 추가할 위치 */
		for (p14_j = p14_i; p14_j > 0; p14_j -= 2)
	...
	do
	{
		...
		/* 코드를 추가할 위치 */
		for (p15_j = 2 * p15_i / 5; p15_j < 10; p15_j += 3)
